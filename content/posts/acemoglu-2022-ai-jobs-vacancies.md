---
title: "人工智能与就业：在线职位空缺的证据 — 深度阅读笔记 — Acemoglu et al."
date: "2026-05-01"
lastmod: "2026-05-01"
author: ["QGQ"]
...
PDF Path:: /Users/double/Zotero/storage/TH4QFLUB/Acemoglu 等 - 2022 - Artificial Intelligence and Jobs Evidence from Online Vacancies.pdf
Zotero Item Key:: KEQ65SD3
...
## 学术思考
1. 这篇论文最值得肯定的地方，是没有把“看不到总量效应”误读成“AI 没影响”。相反，它说明总量指标可能过粗，容易错过企业内部已经发生的任务重组。
2. 识别策略的核心是用基期任务结构预测后续 AI 扩散，这很有说服力，因为它把 AI adoption 的异质性放回到了任务框架中。但同时也要注意：高 AI exposure 的 establishment 可能在其他维度上更前沿，因此完全排除所有共同趋势并不容易。
3. 论文的结论更像“当前 AI 是局部自动化技术”，而不是“AI 必然永远只带来替代”。这点对理解后来生成式 AI 的冲击尤其重要：技术边界一旦变了，生产率效应和互补性可能也会变。
4. 本文主要观察的是 vacancies 而不是实际 employment，因此它最强的证据是“招聘意向与任务重构”，而不是最终就业存量变化。这个区分在写文献综述时应讲清楚。
5. 从政策角度看，论文提示技能培训政策不能只追求“多学 AI”，还要关注哪些原有岗位中的任务正在被弱化，以及哪些新技能在与 AI 协作中变得重要。

## 下一步用户可能提的问题
1. 这篇论文里 establishment-level 结果和 occupation-level 结果为什么会不一致？
2. 作者为什么要剔除 NAICS 51 和 54，这样做会不会影响外部效度？
3. 三种 AI exposure 指标有什么区别，为什么作者更信 Felten 和 Webb？
4. 论文中的 displacement effect 和 productivity effect 在模型里是怎么体现的？
5. 为什么用 vacancies 可以识别 AI 采用，而不只是识别企业“在炒作 AI”？
6. 这篇论文和机器人替代劳动那篇 Acemoglu & Restrepo 的研究有什么联系？
7. 如果放到生成式 AI 时代，这篇论文的结论哪些可能还成立，哪些可能要重写？
8. 如果要把这篇论文写进“AI 对就业影响”的文献综述，应该怎么定位？

## 说明
- 上述解读基于 Zotero 条目的元数据与 PDF 正文可见部分，核心结论来自正文而非仅摘要。
- 可见正文足以支持本文关于数据、理论框架和主要结果的概括；未逐表展开所有附录与稳健性细节，因此对个别数值和附加规格只保留正文中明确可见的表述。