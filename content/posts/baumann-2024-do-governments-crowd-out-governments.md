...
年终支出高峰（Year-End Spending Spike）是全球各国政府普遍存在的现象——政府部门在财政年度结束时集中大量支出。这种支出模式具有几个关键特征：
...
**现有解释的局限。** 文献将年终支出归因于政府部门自身的预算周期（内部因素）：如预防性储蓄基金、拖延行为、或规划不足。但这些解释均未考虑外部因素——其他政府部门和企业的支出行为。
...
**创新解决方案**：利用英国驻海外办事处这一独特自然实验——这些办事处预算遵循英国财年（3月结束），但位于财年各不相同的东道国。
...
**有趣发现**：理论预测拥堵效应应减少年终支出峰值（理性部门会转移支出），但实证结果相反——拥堵效应加剧年终支出。这暗示政府部门的"行为惯性"可能比模型假设的更强。
...
本文揭示了一个有趣的悖论：所有部门都在同一时间"理性"地加大支出以避免资金过期，这种个体理性可能导致整个经济体的集体低效——价格上涨、供应短缺、次优采购。
